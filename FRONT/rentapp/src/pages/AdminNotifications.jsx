...
function AdminNotifications() {
  ...
  const getTypeBadge = (type) => {
    const badges = {
      RENT_REQUEST: { label: "Rent Request", bg: "#eef2ff", color: "#4f46e5", icon: "\u{1F3E0}" },
      CONTRACT: { label: "Contract", bg: "#ecfdf5", color: "#059669", icon: "\u{1F4C4}" },
      GENERAL: { label: "General", bg: "#fef3c7", color: "#b45309", icon: "\u{1F514}" },
    };
    ...
    <MainLayout role="ADMIN">
      ...
      <div className="page-container" style={styles.pageContainer}>
        ...
        <div style={styles.card}>
          {loading ? (
            ...
            <div style={styles.emptyState}>
              ...
              <p style={styles.emptyText}>You'll be notified when there's activity.</p>
            </div>
          ) : (
            <div style={styles.list}>
              {notifications.map((n, index) => {
                ...
                return (
                  ...
                  >
                    {!n.is_read && <div style={styles.unreadBar}></div>}
        ...
        <style>{`
          ...
          .notif-card:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.08) !important; }
